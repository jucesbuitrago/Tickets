# Presentación de Arquitectura: Sistema Anti-Falsificación de Entradas

## 1. Problema y Contexto

### Problema Actual
En la universidad se están falsificando entradas a auditorios de grado. Personas con QR alterados ocupan lugares y dejan por fuera a invitados que viajan desde lejos.
...
### Solución Propuesta
Sistema digital antifraude con QR firmado HMAC, control de cupos y validación en tiempo real.

## 2. Requisitos Clave y Riesgos

### Requisitos Funcionales Principales
- **RF1**: Importación masiva desde Excel de graduandos
...
- **Seguridad**: Firma HMAC con rotación de claves
...
### Escenarios: Ingreso Masivo 10:00 AM
- **Contexto**: 500 usuarios simultáneos
- **Mitigación**: Cache Redis, transacciones optimistas, rate limiting

## 7. Calidad: Cómo se Medirá
...
## 8. Estrategia de Pruebas y Resultados
...
## 9. Desafíos Anticipados y Mitigación
...
## 10. Evolución Tecnológica y Extensibilidad
...
## 11. Riesgos Minimizados por Decisiones Arquitecturales
...
## 12. Demo/Flujo de Escaneo y Aforo
